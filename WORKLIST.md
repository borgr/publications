...
**0 of 2 sections need a decision from you**; the rest resolve themselves, wait on an external source, or are handled automatically and listed for visibility.
